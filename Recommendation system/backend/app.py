...
def test_model():
    ...
    return jsonify({"Test Prediction 1": pred1, "Test Prediction 2": pred2})


# OpenRouter API key and constants
OPENROUTER_API_KEY = (
    "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"
)
# OPENROUTER_API_KEY = (
#     "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"
# )
...
You are an expert career advisor and educational consultant with in-depth knowledge of Pakistan's academic institutions, current job market trends, and future growth sectors. Based on the detailed student profile provided below, your task is to identify the top two most suitable career fields for the student and provide an in-depth recommendation report.

🎯 Objective:
Analyze the student's academic performance, technical and soft skills, personal preferences, and socio-economic background. Then, for each recommended career field, provide:

Career Field Name

Rationale: A concise explanation tailored to the student's unique profile, including why the field suits their background and personality.

Recommended Universities: List nearby or accessible universities/colleges in Pakistan offering relevant programs, with an emphasis on institutions in or near the user address.

Program Details: Duration, curriculum highlights, special features (e.g., industry linkages, internships).

Fee Structure: Approximate tuition fees and additional costs (admission, semester, hostel, etc.).

Scholarship Opportunities: Mention available financial aid options (e.g., merit-based, need-based, HEC, PEEF, university-level).

📘 Student Profile: Consider the above informations we are getting from the frontend form
