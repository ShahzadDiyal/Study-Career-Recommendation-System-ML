...
import "../css/forBetterRecommendations.css";
        ...
        >
          ...
          <div className="row">
            ...
            <div className="col-md-6 mb-3">
              ...
              className="form-control" 
              name="budget"
              placeholder="Enter your Budget (fifty thousand or 50000-50000)"
                onChange={handleChange}/>
          ...
          <div className="row">
            {["english", "urdu", "pak_study", "islamic_studies"].map(
              renderSubjectInput
            )}
          </div>
